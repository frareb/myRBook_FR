...
### Transformer ces données au format TXT ou CSV {#l016transfo}
...
En consultant l'aide sur la fonction `read.table()`, nous puvons voir qu'elle possède de nombreux arguments. Les princaux sont les suivants :
