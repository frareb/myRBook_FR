...
Nous pouvons aussi calculer la moyenne por chaque valeur de ligne et de colonne (la fonction itère alors sur la dimension 3) :
...
La fonction `sapply()` est intéressante pour récupérer par exemple le nième élément de cahcun des élément d'une `list`. La fonction qui est appelée pour faire cela est `'[['`.
