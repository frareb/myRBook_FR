...
myX <- rnorm(50, mean = 0, sd = 1) # tirage aléatoire dans un loi Normale
myY <- rnorm(50, mean = 10, sd = 1) # tirage aléatoire dans un loi Normale
plot(x = myX, y = myY)
```
...
myX <- c(4, 5, 8)
par(mar = c(3, 3, 1, 1)) # réduction des marges
