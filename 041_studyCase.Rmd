...
```{r 041-studyCase-8, fig.width=10, fig.height=6, out.width = '70%'}
...
```{r 041-studyCase-9, fig.width=10, fig.height=6, out.width = '70%'}
...
```{r 041-studyCase-11, fig.width=10, fig.height=6, out.width = '70%'}
...
```{r 041-studyCase-12, fig.width=10, fig.height=6, out.width = '70%'}
par(mar = c(5, 4, 0, 0))
boxplot(
...
```{r 041-studyCase-13, fig.width=10, fig.height=6, out.width = '70%'}
...
```{r 041-studyCase-14, fig.width=10, fig.height=6, out.width = '70%'}
pkgCheck <- function(x){ 
...
```{r 041-studyCase-15, fig.width=10, fig.height=6, out.width = '70%'}
...
```{r 041-studyCase-16, fig.width=10, fig.height=6, out.width = '70%'}
...
```{r 041-studyCase-17, fig.width=10, fig.height=6, out.width = '70%'}
...
```{r 041-studyCase-18, fig.width=10, fig.height=6, out.width = '70%'}
par(mar = c(4, 4, 1, 1)) # réduction des marges
plot(
  x = hours, 
