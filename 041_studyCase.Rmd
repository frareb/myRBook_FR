...
```{r 041-studyCase-8, fig.width=10, fig.height=6, out.width = '80%'}
...
```{r 041-studyCase-9, fig.width=10, fig.height=6, out.width = '90%'}
...
Nous pouvons très facilement représenter la même information par semaine. Il suffit de changer l'argument `INDEX` pour une date en semaine. Voici un exemple de format par semaine :
...
```{r 041-studyCase-11, fig.width=10, fig.height=6, out.width = '90%'}
...
Dans ce type de représentation nous perdons l'information sur la variabilité des températures par semaine. En fonction des objectifs il pourra être intéressant de préférer une représentation sous forme de `boxplot` (ici un boxplot par mois en formatant la date avec `"%Y-%m"`).

```{r 041-studyCase-12, fig.width=10, fig.height=6, out.width = '90%'}
par(mar = c(5, 4, 0, 0))
boxplot(
...
Pour comparer les différentes valeurs de température, il peut être utile d'attribuer une couleur à chaque boxplot. Par exemple, nous pouvons utiliser un gradient de couleurs du bleu au rouge en utilisant la valeur moyenne de la température.

```{r 041-studyCase-13, fig.width=10, fig.height=6, out.width = '90%'}
...
```{r 041-studyCase-14, fig.width=10, fig.height=6, out.width = '100%'}
pkgCheck <- function(x){ 
...
```{r 041-studyCase-15, fig.width=10, fig.height=6, out.width = '100%'}
...
```{r 041-studyCase-16, fig.width=10, fig.height=6, out.width = '100%'}
...
```{r 041-studyCase-17, fig.width=10, fig.height=6, out.width = '100%'}
...
```{r 041-studyCase-18, fig.width=10, fig.height=6, out.width = '100%'}
par(mar = c(4, 4, 1, 1)) # réduction des marges
plot(
  x = hours, 
...
```{r 041-studyCase-19, fig.width=10, fig.height=6}
pkgCheck <- function(x){ 
  if (!require(x, character.only = TRUE)){
    install.packages(x, dependencies = TRUE)
    if(!require(x, character.only = TRUE)) {
