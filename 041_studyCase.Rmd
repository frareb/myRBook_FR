...
# Manipuler des dates et des heures : données de datalogger de température {#studyCase001}
...
# URL <- "https://raw.githubusercontent.com/frareb/myRBook_FR/
#   master/myFiles/E05C13.csv"
# bdd <- read.table(
#   URL, 
#   skip = 1, 
#   header = TRUE,
...
```{r 041-studyCase-8, fig.width=10, fig.height=6}
...
```{r 041-studyCase-9, fig.width=10, fig.height=6}
...
```{r 041-studyCase-11, fig.width=10, fig.height=6}
...
```{r 041-studyCase-12, fig.width=10, fig.height=6}
par(mar = c(5, 4, 1, 1)) # réduction des marges
...
```{r 041-studyCase-13, fig.width=10, fig.height=6}
...
```{r 041-studyCase-14, fig.width=10, fig.height=6}
pkgCheck <- function(x){ 
...
```{r 041-studyCase-15, fig.width=10, fig.height=6}
...
```{r 041-studyCase-16, fig.width=10, fig.height=6}
...
```{r 041-studyCase-17, fig.width=10, fig.height=6}
...
```{r 041-studyCase-18, fig.width=10, fig.height=6}
par(mar = c(4, 4, 1, 1)) # réduction des marges
