...
```{r screenCapConsole, fig.cap = "Capture d'écran de la console R sous Windows.\\label{fig:screenCapConsole}", echo = FALSE, out.width = '100%'}
...
```{r screenCapConsoleCal, fig.cap = "Capture d'écran de la console R sous Windows avec la calculatrice Windows.\\label{fig:screenCapConsoleCal}", echo = FALSE, out.width = '100%'}
