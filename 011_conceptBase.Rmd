...
Les commentaires peuvent aussi être utilisé pour qu'une ligne ne soit plus exécutée.
...
* Créez **objets** et les utiliser pour les calculs arithmétiques, de comparaison et de logique
* Choisir des noms pertinents pour les objets
* Créer de nouveaux **script**
